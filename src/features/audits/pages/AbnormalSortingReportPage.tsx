...
function StatBox({ label, value }: { label: string; value: React.ReactNode }) {
    return (
        <div className="flex-1 rounded-2xl border border-white/10 bg-white/5 px-4 py-5">
            <div className="text-[11px] font-semibold tracking-wide text-slate-400 text-center">{label.toUpperCase()}</div>
            <div className="mt-2 text-center text-4xl font-extrabold tracking-tight text-blue-400">{value}</div>
        </div>
    );
}
...
export default function AbnormalSortingReportPage() {
    ...
    async function analyze() {
        ...
        try {
            ...
            const json = await apiPostMultipart<AbnormalSortingResponse>("/api/audits/abnormal-sorting/analyze", form);
            setData(json);
        } catch (e: any) {
        ...
        <div className="pb-10">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                <div>
                    ...
                    <div className="mt-1 text-sm text-slate-400">Upload one Excel file and review operator results.</div>
                </div>
                ...
                <div className="mt-6 rounded-2xl border border-white/10 bg-white/5 p-5">
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="mt-1 text-xs text-slate-400">Single file upload. Backend returns stats and results.</div>
